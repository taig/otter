...
trait JsonDsl
  ...
  object dictionary extends DictionaryDsl[Json.Dictionary, Json.Key, Json]:
    override protected def fromDictionary[A](self: Dictionary[Key, Json, A]): Json.Dictionary[A] =
  ...
  object key
    ...
    override protected def fromConstant[A](self: Constant[Key.Primitive, A]): Json.Key.Constant[A] =
      Json.Key.Constant(self)
    override protected def fromEnumeration[A](self: Enumeration[Key.Primitive, A]): Json.Key.Enumeration[A] =
