...
object HttpParameterObjectValueEncoder extends Encoder[Parameter.Schema.Object.Atom, Option[String]]:
  ...
  override def encode[A](schema: Parameter.Schema.Object.Atom[A], a: A): Option[String] = schema match
    ...
    case schema: Parameter.Schema.Atom[A]            => ParameterValueAtomPrinter.encode(schema, a).some
