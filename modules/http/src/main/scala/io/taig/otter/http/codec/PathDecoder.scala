...
// final class PathDecoder[F[_]](parser: Parser[F]) extends Decoder.Remaining[Path.Read[F, *], Chain[String]]:
...
//         .andThen((value, remainders) => parser.decode(segment.value, value).tupleLeft(remainders))
