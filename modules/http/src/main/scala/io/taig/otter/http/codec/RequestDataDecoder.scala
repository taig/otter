...
//         HeadersDataDecoder.decodeRemainding(headers, value = value.headers).leftMap("header" /: _)
...
//       HeadersDataDecoder.decodeRemainding(headers, value = value.headers) match
