...
object HeaderValueObjectValueEncoder extends Encoder[Header.Schema.Object.Atom, Option[String]]:
  ...
  override def encode[A](schema: Header.Schema.Object.Atom[A], a: A): Option[String] = schema match
    ...
    case schema: Header.Schema.Atom[A]            => HeaderValueAtomPrinter.encode(schema, a).some
