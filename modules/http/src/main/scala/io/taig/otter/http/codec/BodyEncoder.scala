...
// import io.taig.otter.http.Value
...
//     case Value.Modify(self, f, g)        => encode(schema = self, g(a))
//     case Value.Root(contentType, schema) => encoder.encode(schema = schema.value, a)
