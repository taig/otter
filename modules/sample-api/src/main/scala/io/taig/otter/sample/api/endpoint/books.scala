...
object books:
  ...
  object get:
    def apply(): RoleEndpoint[Role.Guest, Unit, List[BookApiSchema.Summary]] = endpoint(
  ...
  object post:
    ...
    def apply(): RoleEndpoint[Role.Librarian, BookApiSchema.Create, Either[Error, BookApiSchema]] =
      endpoint(
