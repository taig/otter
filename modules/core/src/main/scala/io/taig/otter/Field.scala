...
object Field:
  ...
  object Read:
    inline def apply[F[+_[a] <: H[a], _], G[+_[a] <: H[a], _], H[_]](using self: Field.Read[F, G, H]): Field.Read[F, G, H] =
      self

    given InvariantK3[Field.Read] with
      extension [F[+_[_], _], G[+_[a] <: H[a], _], H[_]](fa: Field.Read[F, G, H])
        def imapK[I[+_[_], _]](fK: [S[_], A] => F[S, A] => I[S, A])(
            gK: [S[_], A] => I[S, A] => F[S, A]
        ): Field.Read[I, G, H] = fa.imapK(fK)(gK)
  ...
  object Write:
    ...
    given InvariantK3[Field.Write] with
      extension [F[+_[_], _], G[+_[a] <: H[a], _], H[_]](fa: Field.Write[F, G, H])
        def imapK[I[+_[_], _]](fK: [S[_], A] => F[S, A] => I[S, A])(
            gK: [S[_], A] => I[S, A] => F[S, A]
        ): Field.Write[I, G, H] = fa.imapK(fK)(gK)

  inline def apply[F[+_[_], _], G[+_[a] <: H[a], _], H[_]](using self: Field[F, G, H]): Field[F, G, H] = self

  given InvariantK3[Field] with
    extension [F[+_[_], _], G[+_[a] <: H[a], _], H[_]](fa: Field[F, G, H])
      def imapK[I[+_[_], _]](fK: [S[_], A] => F[S, A] => I[S, A])(
          gK: [S[_], A] => I[S, A] => F[S, A]
      ): Field[I, G, H] = fa.imapK(fK)(gK)
