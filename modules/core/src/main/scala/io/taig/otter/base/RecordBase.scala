...
object RecordBase:
  ...
  object Read:
    ...
    given [S[_]]: Record.Read[RecordBase.Read, S] with
      ...
      extension [A](fha: RecordBase.Read[S, A]) override def fields: Chain[Reference[S, ?]] = fha.fields
  ...
  object Write:
    ...
    given [S[_]]: Record.Write[RecordBase.Write, S] with
      ...
      extension [A](fha: RecordBase.Write[S, A]) override def fields: Chain[Reference[S, ?]] = fha.fields
  ...
  given [S[_]]: Record[RecordBase, S] with
    ...
    extension [A](fha: RecordBase[S, A]) override def fields: Chain[Reference[S, ?]] = fha.fields
