...
// trait Value[+O <: Data.Primitive | Data.Null.type, A] extends Codec[O, A]:
...
//   override def optional: Value[O | Data.Null.type, Option[A]]
...
// object Value:
//   trait Required[+O <: Data.Primitive, A] extends Value[O, A], Codec.Required[O, A]:
...
//   object Required:
//     given [O <: Data.Primitive]: Invariant[Value.Required[O, *]] with
//       override def imap[A, B](fa: Value.Required[O, A])(f: A => B)(g: B => A): Value.Required[O, B] = fa.imap(f)(g)

//   given [O <: Data.Primitive | Data.Null.type]: Invariant[Value[O, *]] with
