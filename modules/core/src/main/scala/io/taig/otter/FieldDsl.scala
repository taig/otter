...
// trait FieldDsl[+Self[_], -Key[_], -Value[_], Record[_]](using codec: Codec.Field[Self, Key, Value, Record]):
...
//       extends FieldDsl.Primitive.Boolean[Self, Key, Value, Record],
//         FieldDsl.Primitive.Number[Self, Key, Value, Record],
//         FieldDsl.Primitive.String[Self, Key, Value, Record]:
//     override def key: PrimitiveDsl[Key]

//   object Primitive:
//     trait Boolean[+Self[_], Key[_], -Value[_], Record[_]] extends FieldDsl[Self, Key, Value, Record]:
...
//     trait Number[+Self[_], Key[_], -Value[_], Record[_]] extends FieldDsl[Self, Key, Value, Record]:
...
//     trait String[+Self[_], Key[_], -Value[_], Record[_]] extends FieldDsl[Self, Key, Value, Record]:
