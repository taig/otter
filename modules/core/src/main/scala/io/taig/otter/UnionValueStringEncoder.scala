...
object UnionValueStringEncoder:
  def apply[A](schema: Union.Value.Via[String, A], a: A): Option[String] = schema match
    case schema: Union.Value.Required.Via[String, A] => UnionValueRequiredStringEncoder(schema, a).some
