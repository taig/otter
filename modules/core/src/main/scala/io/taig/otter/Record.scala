...
abstract class Record[+O <: Data.Optional[Data.Object[?]], A] extends Codec[O, A]:
  ...
  final def product[P <: Data.Optional[Data.Object[?]], B](codec: Record[P, B]): Record[O & P, (A, B)] =
    new Record[O & P, (A, B)]:
      ...
      ): Codec.Result[(Option[Chain[(String, Data[?])]], (A, B))] =
      ...
      override def encode(ab: (A, B)): O & P = (self.encode(ab._1), codec.encode(ab._2)) match
        case (a: Data.Object[?], b: Data.Object[?]) => ???
  ...
  final def zip[P <: Data.Optional[Data.Object[?]], B](codec: Record[P, B])(using
      merge: Evidence.Merge[A, B]
  ): Record[O & P, merge.Out] = ???
...
object Record:
  val Empty: Record[Data.Object[Nothing], Unit] = new Record[Data.Object[Nothing], Unit]:
    ...
    ): Codec.Result[(Option[Chain[(String, Data[?])]], Unit)] =
      (data, ()).valid
