...
trait InvariantK9[F[
  ...
  extension [
      ...
      BoundRead[_],
      BoundWrite[_]
  ](fa: F[Self, SelfRead, SelfWrite, Schema, SchemaRead, SchemaWrite, Bound, BoundRead, BoundWrite])
    def imapK[
    ...
    ): F[SelfK, SelfReadK, SelfWriteK, Schema, SchemaRead, SchemaWrite, Bound, BoundRead, BoundWrite]
...
object InvariantK9:
  inline def apply[F[
      ...
      boundRead[_],
      boundWrite[_]
  ]](using self: InvariantK9[F]): InvariantK9[F] = self
