...
//    case crock: OpenApi.Object => decode(crock)
//    case _                       => typeViolations("Object", crock).invalid
//
//  def decode(crock: OpenApi.Object): Validated[Violations, A]
//
//object Dictionary:
...
//    override def decode(crock: OpenApi.Object): Validated[Violations, C] =
//      dictionary.decode(crock).andThen(applyValidation(validation, dictionary.encode))
