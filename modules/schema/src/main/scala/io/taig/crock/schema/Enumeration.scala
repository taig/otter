...
//    case crock: OpenApi.Primitive => decode(crock)
//    case _                          => typeViolations("Primitive", crock).invalid
//
//  def decode(crock: OpenApi.Primitive): Validated[Violations, A]
//
//object Enumeration:
...
//    override def decode(crock: OpenApi.Primitive): Validated[Violations, C] =
//      enumeration.decode(crock).andThen(applyValidation(validation, enumeration.encode))
