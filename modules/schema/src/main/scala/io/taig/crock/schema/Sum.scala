...
//    override def tryDecode(crock: OpenApi): Ior[Violations, Option[B]] = branch.decode(crock, discriminator)
...
//    override def tryDecode(crock: OpenApi): Ior[Violations, Option[D]] = sum.tryDecode(crock) match
