...
/** Writes a request from what it holds, which is the same walk [[Http4sRequestDecoderUnchecked]] makes in reverse.
  *
  ...
  */
final private[http] class Http4sRequestEncoderUnchecked(payload: Http4sPayload[?])
  ...
  private def encode[W](
    ...
    case Request.Value.Streamed(self, _)  => encode(self, w)
