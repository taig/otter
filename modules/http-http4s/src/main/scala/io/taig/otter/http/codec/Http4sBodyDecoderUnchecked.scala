...
/** Reads a body out of the bytes that arrived, and the media type they arrived under.
  ...
  */
final private[http] class Http4sBodyDecoderUnchecked(payload: Http4sPayload[?])
    extends Decoder[Body.Node, (Option[MediaType], ByteVector)]:
