...
final class TypescriptRenderer[S[_]: SchemaInvariant](
  ...
  def renderMetadataOrSchema[A](schema: S[A]): TypescriptState[Typescript] =
    schema.metadata(TypescriptKeys.typescript) match
