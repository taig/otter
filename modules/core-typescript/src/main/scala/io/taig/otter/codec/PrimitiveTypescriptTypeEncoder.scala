...
final class PrimitiveTypescriptTypeEncoder[F[_]](encoder: => Encoder[F, Typescript.Type])
    extends Encoder[Primitive.Write[F, *], Typescript.Type]:
  override def encode[A](schema: Primitive.Write[F, A], a: A): Typescript.Type = schema match
