...
object PrimitiveTypescriptExpressionLiteralEncoder extends Encoder[Primitive.Write, Typescript.Expression.Literal]:
  @tailrec
  override def encode[A](schema: Primitive.Write[A], a: A): Typescript.Expression.Literal = schema match
