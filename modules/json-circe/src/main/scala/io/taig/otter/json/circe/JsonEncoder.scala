...
object JsonEncoder extends Encoder[[a] =>> Schema.Writer[Schema.Writer.Identity[a], a], Json]:
  override def apply[B](schema: Schema.Writer[Schema.Writer.Identity[B], B], b: B): Json = schema match
