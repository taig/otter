...
object JsonTypescriptZodRenderer extends Renderer[Json, TypescriptZodState[TypescriptZod]]:
  val core: Renderer[Json, TypescriptZodState[Typescript[TypescriptZod]]] =
    TypescriptRenderer[
      Json,
      Json.Primitive,
      Json.Field,
  ...
  val renderer = ReferenceTypescriptRenderer(MetadataTypescriptZodRenderer(core))(lift = TypescriptZod.Shared.apply)
